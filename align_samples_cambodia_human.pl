...
my $genome = "/local/projects-t3/SerreDLab-3/kieran.tebben/mali/genomes/human_pv_index";
my $sam;
my $log;
my $bam; 
my $sorted;
...
open (IN, "/local/projects-t3/SerreDLab-3/kieran.tebben/PQRC_bulk/sample_lists/artesunate_resistance3.txt");
my @sample_names;
...
for my $sample (@sample_names) {
	print "$sample\n";
	$sample_directory = "/local/projects-t4/aberdeen2ro/SerreDLab-4/raw_reads/2023-07-10_UMB/PQRC21/${sample}/ILLUMINA_DATA/";
