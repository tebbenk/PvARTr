...
my @bamfiles = </local/projects-t3/SerreDLab-3/kieran.tebben/PQRC_longitudinal/bams_71924/bam_human/*subset_human.bam>;
my $bam;

open(OUT2, ">", "/local/projects-t3/SerreDLab-3/kieran.tebben/PQRC_longitudinal/bams_71924/bam_human/percent_dup_human_PID61.txt");
...
foreach $bam (@bamfiles){
	...
	print "$sample\n";
	my $bam_rmdup = "${sample}_rmdup.bam";
...
#	print "$percent_dup\n";
	print OUT2 "Sample\tReadPairs\tDuplicates\tPercentDuplicates\n";
	print OUT2 "$sample";
	print OUT2 "\t$total";
