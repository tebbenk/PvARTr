...
my @bamfiles = </local/projects-t3/SerreDLab-3/kieran.tebben/PQRC_longitudinal/bams_71924/bam_pv/*subset_pv.bam>;
my $bam;

open(OUT2, ">", "/local/projects-t3/SerreDLab-3/kieran.tebben/PQRC_longitudinal/bams_71924/bam_pv/percent_duplicate_pv_61redos.txt");
